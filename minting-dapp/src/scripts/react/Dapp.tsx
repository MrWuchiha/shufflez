...
export default class Dapp extends React.Component<Props, State> {
  ...
  componentDidMount = async () => {
    ...
    if (browserProvider?.isMetaMask !== true) {
      this.setError(
        <>
          Please connect to <strong>MetaMask</strong>.<br />
          <br />
      ...
      <>
            ...
            {this.isContractReady() ?
              ...
              <div className="collection-not-ready">
                <svg className="spinner" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                  ...
                  <path className="opacity-75" fill="#eecf90" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                </svg>
        ...
        :
          <div className="no-wallet">
            {!this.isWalletConnected() ? <button disabled={this.provider === undefined} onClick={() => this.connectWallet()}>Connect Wallet</button> : null}
  ...
  private async initWallet(): Promise<void>
  {
    ...
    if (await this.provider.getCode(CollectionConfig.contractAddress!) === '0x') {
      this.setError('Could not find the contract, please make sure you are connected to the right chain.');
