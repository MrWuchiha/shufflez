...
type ActionName = 'BookAction' | 'DetailsAction' | 'DetailsAction2' | 'ArmatureAction' | 'ArmatureAction2' | 'TextAction'
...
export function Model(props: JSX.IntrinsicElements['group']) {
  ...
  materials.Material.color = new Color("fcd34d").convertSRGBToLinear();
  ...
  return (
    ...
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        ...
        <mesh name="Text" geometry={nodes.Text.geometry} material={materials.Material} position={[0.01, 0.26, 0.55]} rotation={[0.61, 0, 0]} />
      </group>
    </group>
  )
}
